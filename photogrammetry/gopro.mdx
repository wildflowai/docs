...
🔵 **Corner Markers** -- Metal stakes or similar objects (could even be bricks). We need to make sure we map the same area when you come next time in a few months or years.
...
🔵 **Transects** -- Guide you underwater when mapping the reef. For a 25x25m Patch you could use 8 transect lines of 25m, or a combo of 50m and 25m lines.

🔵 **GPS** -- Capture the location of Corner Markers from the surface, needed for georeferencing and to find the Corner Markers next time you dive.
...
🔵 **SMB** -- Surface Marker Buoy for safety and optionaly marking the corner of the Patch.
...
🔵 **Set the cameras** to Photo mode (Wide angle, Superphoto or Normal, best quality JPG).
...
🔵 **Choose a site** that needs to be mapped. Think about how the Patch will be located and where its sides will end up.
...
🔵 **Capture GPS coordinates** of all Corner Markers. This can be done anytime, usually by someone snorkelling.

## 3. Transects

🔵 **Lay out outer Transects** to form the perimeter of the 25x25m Patch. This can be done while installing Corner Markers.
...
🔵 **Lay out inner Transects** every 5 m intervals within the 25x25m box. It should look like swimming pool divider lines.
...
🔵 **Evenly distribute Scalebars** across the Patch. For example, place 4 in the corners and 1 in the centre. Ensure they're visible from different sides.

🔵 **Place Colour Charts** near Scalebars so they're easy to find.

🔵 **Measure the depth** of each Scalebar using your Dive Computer. Place the computer on the marker and note the depth, or take a photo for reference. Record the Scalebar identifier code and depth, e.g., '007 - 3.5m'.
...
🔵 **Check the camera rig** is stable and both cameras are facing downs.

🔵 **Turn on both cameras** before descending. Make sure they're set to Photo mode, taking pictures every 0.5 seconds.

🔵 **Press the record button** on both cameras once you're underwater and ready. It's okay if they're not perfectly synchronised.

🔵 **Confirm both cameras are working**. Ensure the photo count number is increasing on the screen or whether there is a blinking red activation light.

## 2. Positioning

🔵 **Hold the camera rig** in front of you, keeping both cameras pointing straight down to the coral substrate.

🔵 **Stay 1-2m above the reef**, aiming for 1.5m. This keeps everything in focus.
...
🔵 **Start and end outside the edges** by 1.5-2 metres to ensure full coverage.
...
🔵 **Keep each swim line** about 1.5m from the last one. This ensures photos overlap without too much duplication.

🔵 **When turning**, swim a bit farther out (1.5-2m) beyond the Patch edge to avoid gaps.
