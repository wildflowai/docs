...
icon: "send-back"
description: "How to capture a 3D model of coral reef using just two GoPros"
---
...
* 2+ SD cards (**V30 or faster** please)A 25x25m quadrat requires up to 20GB per camera.A 128GB card is perfect for 6 quadrats.
...
* **Time vs. Detail**: Swimming slower and closer gives you more detailed photos but increases the risk of gaps if you're not careful. Swimming higher and faster covers more ground but sacrifices some detail. Our protocol strikes a balance, but feel free to adjust based on your goals. Just remember: a complete model is better than a patchy one!

* **Data Volume**: High-frequency photo capture (every 0.5 seconds) ensures plenty of overlap but generates large files. A 128GB SD card can handle about six 25x25m quadrats, but always test your setup on land to avoid surprises underwater.
...
Feel free to ask questions or share your experiences in our [Discord](http://wildflow.ai/discord) -- we'd love to hear from you! 🤗

***

Special thanks to [John Stratford](https://x.com/JohnStratford_), [Jason Lynch](https://www.linkedin.com/in/jason-lynch-442575153), [Will Barnes](https://www.linkedin.com/in/william-barnes-a292b41a7), and [Ben Williams](https://www.linkedin.com/in/ben-williams-ucl) for their invaluable insights and best practices on data collection.

**Why We Do This**: Coral reefs are the rainforests of the sea, teeming with life and beauty. By mapping them, you're not just creating a 3D model -- you're helping to preserve and restore a piece of our planet's future. Imagine looking back in a few years and seeing how your work has contributed to restoring a thriving reef. That's the power of what you're doing. So, gear up, dive in, and let's make a difference together!