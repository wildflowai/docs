...
🔵 Set **Photo mode** (**Superphoto** or Normal, best quality **JPG**).

🔵 Interval photos **every 0.5 seconds**.
...
🔵 Choose a site that needs to be mapped. Think how the quadrat would be placed here, where its sides would end up.

🔵 Install 4 Corner Markers defining survey area. This is usually done together when laying out Transects.
...
🔵 Capture GPS coordinates of all Corner Markers. This step could be done anytime, usually by a snorkeler.

## 3. Transects

🔵 Lay out outer Transects making perimeter of the 25x25m quadrat that we're planning to image. This could be done while installing Corner Markers.
...
🔵 Then lay out inner Transects every 5 meters.
...
🔵 Evenly distribute Scalebars across the quadrat. For example, put 4 in the corners and 1 in the centre. Make sure they are visible from different sides.

🔵 Place Colour Charts them near Scalebars, so they are easy to find.

🔵 Measure the depth of each Scalebar (only one side of the dumbbell) using your dive computer (you can put your dive computer on the marker and take a picture of it) or write it down the depth. We need scalebar identifier and depth, e.g. `007 - 3.5m`.
...
🔵 Make sure we captured GPS coordinates of all Corner Markers and depths of Scalebars.

🔵 Collect all Scalebars, Transects and SMB. Make sure you don't leave anything except permanent Corner Markers.
...
- We are aware of GoPro’s slow rolling shutter speed – the pixel column on the left side of the frame captures a moment in time different from the pixel column on the right side of the frame, causing less accurate geometry. We think it matters for millimetre resolution, but far away from being a problem for centimetre resolution. Thanks [Will Greene](https://github.com/wogreene) for pointing out.
...
Enjoy mapping corals! Please feel free to ask any questions in our [Discord](http://wildflow.ai/discord) 🤗
