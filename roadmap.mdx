...
This is a timeline for our first product [Wildflow Coral](/coral).

<img
  className="block dark:hidden"
  src="https://wildflow.ai/images/roadmap-light.svg"
  alt="wildflow roadmap light"
/>
<img
  className="hidden dark:block"
  src="https://wildflow.ai/images/roadmap-dark.svg"
  alt="wildflow roadmap dark"
/>
...
<Steps>
  ...
  <Step title="MULTIMODAL in 1 year">
