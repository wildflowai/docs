---
title: "Merge Data"
description: "This tutorial shows how to **join** your **observational** data with **envirounmental** data"
icon: "globe"
---
...
![upload-your-csv-file](/images/tutorials/merge-data/upload-your-csv-file.png)
...
![update-column-names](/images/tutorials/merge-data/update-column-names.png)
...
![select-tables](/images/tutorials/merge-data/select-tables.png)

### 3. Select result columns

![result-columns](/images/tutorials/merge-data/result-columns.png)
...
![code](/images/tutorials/merge-data/code.png)
...
<img width="300" src="/images/tutorials/merge-data/job-status.png" />

You can see most recent jobs here: [Jobs](https://wildflow-demo.web.app/jobs).

And it should finish with a few minutes:

<img width="300" src="/images/tutorials/merge-data/job-complete.png" />
